  ...
  return (
    <section className="relative flex min-h-[86vh] items-end overflow-hidden bg-pine-900">
      {settings?.hero_video_url ? (
        ...
        <img src={heroImage} alt="Xonobod tabiati" className="absolute inset-0 h-full w-full object-cover opacity-70" />
      )}
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 pb-20 pt-40 sm:px-6">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link to="/xonobod-haqida" className="btn-gold">
            {settings?.hero_cta_primary_label ?? "Xonobodni kashf eting"}
          </Link>
